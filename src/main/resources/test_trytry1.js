 ...
 */
 ...
 //     isNotify: process.env.JD_TRY_NOTIFY || true,
      ...
      * */
     titleFilters: process.env.JD_TRY_TITLEFILTERS && process.env.JD_TRY_TITLEFILTERS.split('@') || ["玻璃防雾剂", "梳子", "座套", "视线盲区贴纸", "卧铺垫" ,"定做榻榻米","别针","抽纸一包装","儿童","反光条贴","门槛条","腋毛神器","幼儿配方","甲醛","地吸","定做","汽车脚垫","砂盆","电池","加温器","矫正带","手机维修","锁精环","包皮","扩音器","龟头","猫粮","狗粮","神露","前列腺","硅胶","儿童成长","孕妇","尤尖锐湿疣","痔疮","乳腺","蟑螂药","用友","自慰","儿童口罩","啪啪","门把手","鞋带","丰胸","多功能尺子","情趣","适配器","尼龙管","铆管","哺乳套装","屏蔽袋","SD卡","条码","钢化蛋","鸭肠","猪油","绿幕","尿素霜","婴儿","分流器","VGA","纸尿裤","墨盒","水晶头","眼霜","机顶盒","数据线","交换机","屏风","地漏","彩带","便秘","插座","密封条","玻璃镜片","摄像头镜片","腰带","皮带","裤头","眼镜","框","老花","USB","雨刮","车漆","帽","宠物","幼儿园","收纳","衣架","鼠标垫","卡套","避孕套","架","夹","手机壳","小学","牙刷头","安全帽","挂钩","油漆","烟","笔","保护套","飞机","手套","护肤","洗面","清洁","膜","理发","润滑","延时","usb","坐垫","酒","毛孔","墨水","托","耳罩","袖套","丝袜","飞机杯","袜子","滤网","砂纸","眼影","钢化膜","鞋垫","内裤","面膜","手机卡","流量卡","胶带","艾条","便签纸","电池","花籽","工作服","眉笔","口红","挑逗","卡托","保护套","字帖","钉子","坐垫","数据线","座垫","电缆剪"],
